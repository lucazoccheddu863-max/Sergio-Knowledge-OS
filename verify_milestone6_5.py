#!/usr/bin/env python3
"""Verify script for M6.5 — Backup Restore Inspection."""
...
def main() -> int:
    ...
    if version == "0.6.0-alpha5" and "M6.5" in changelog:
        print(f"  OK VERSION = {version}; CHANGELOG includes M6.5")
    else:
        print("  FAILED version or changelog")
        return 1

    print("\n[5/5] Checking restore inspection import...")
    ...
    if BackupArchiveInspection and inspect_backup_archive:
        print("  OK restore inspection import PASS")
    else:
        print("  FAILED restore inspection import")
        return 1

    print("\n" + "=" * 60)
    print("M6.5 verification complete. All checks PASS.")
    print("=" * 60)
    return 0
