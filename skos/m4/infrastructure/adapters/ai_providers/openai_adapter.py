"""OpenAI adapter — ChatGPT and embeddings."""
...
from skos.m4.infrastructure.ports.ai_provider_port import AIProviderAuthError, AIProviderError, AIProviderPort, AIProviderRateLimitError


class OpenAIAdapter(HTTPMixin, AIProviderPort):
    ...
    def chat(self, request: ChatRequest) -> ChatResponse:
        ...
        try:
            ...
            if hasattr(exc, "code") and exc.code == 401:  # type: ignore[attr-defined]
                raise AIProviderAuthError(str(exc)) from exc
