#!/usr/bin/env python3
"""Setup script for Milestone 4.1 — Step 2: Event Bus & Application Layer.

This script:
1. Installs the project package in editable mode (with dev dependencies)
2. Verifies the installation
3. Runs the M4 test suite

Usage:
    python setup_milestone4_1_step2.py
"""
...
def main() -> int:
    ...
    try:
        ...
        import skos.m4.application.services.import_orchestrator
    ...
    print("\n" + "=" * 60)
    print("🎉 M4.1 STEP 2 SETUP COMPLETE")
    print("=" * 60)
    print("\nYou can now run:")
    print("    python verify_milestone4_1_step2.py")
    print("=" * 60)
